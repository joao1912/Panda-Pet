...
function initializeProducts() {
    ...
    const initialProducts = [
        ...
        new Produto(0, "Bifinho sabor carne", "Bifinho saudável para seu cachorro, sabor carne.", "./imagens/alimentacao/bifinhoSaborCarne.png", 19.90, "alimentacao", "Bifinho para cães adultos com sabor de carne, contém 100 gramas.", 10,4),
        new Produto(1, "Ração para cachorro porte M", "Ração natural com ingredientes orgânicos para cachorros porte médio.", "./imagens/alimentacao/gran-nature.png", 120.00, "alimentacao", "Ração para cachorros médio, feito com ingredientes orgânicos, contém 1 quilo.", 10,3),
        new Produto(2, "Sache para gatos", "Petisco saboroso que auxilia na saúde do seu gatinho.", "./imagens/alimentacao/mik-cat-sache.png", 12.99, "alimentacao", "Sache para gatos filhotes, sabor de carne, contém 100 gramas.", 10,3),
        ...
        new Produto(6, "Ração para gatos", "Ração para seu gatinho que auxilia na sua saúde.", "./imagens/alimentacao/racaoCat.png", 89.90, "alimentacao", "Ração para gatos adultos, sabor frango, contém 10 quilos", 10,4),
        new Produto(7, "Ração para gatos fihotes", "Ração formulada para gatinhos que acabaram de sair do leite.", "./imagens/alimentacao/racaoFilhoteCat.jpg", 79.99, "alimentacao", "Ração para gatos filhotes, sabor carne, contém 500 gramas, ideal para gatinhos que acabaram de sair do leite.", 10,3),
        ...
        new Produto(9, "Arranhador", "Arranhador resistente com plataforma para gatos afiarem as unhas.", "./imagens/brinquedos/arranhador-brinquedo-cat.jpg", 59.99, "brinquedos", "Arranhador de cor rosa em formato de peixe, contém na parte de dentro um arranhador para as unhas e em volta bolinhas azuis para seu gatinho brincar.", 10,4),
        new Produto(10, "Bolinhas de borracha", "Bolinhas para cães brincarem e exercitarem a mandíbula.", "./imagens/brinquedos/bolinhasCaes.png", 9.99, "brinquedos", "Bolinhas de borrachas de várias cores aleatórias, algumas com formato  mini de bola de fútbol e basquete.", 10,4),
        ...
        new Produto(14, "Hamburguer para morder", "Hamburguinho de borracha para seu cachorro morder sem medo!.", "./imagens/brinquedos/hamburguer-dog.png", 12.90, "brinquedos", "Brinquedo de borracha em forma de hamburguer, para seu pet morder sem medo.", 10,3),
        new Produto(15, "Limpa dentes para cachorros", "O brinquedo ideal para seu pet se divertir e limpar seus dentinhos.", "./imagens/brinquedos/limpadente.png", 22.90, "brinquedos", "Plataforma vertical de borracha, na cor verde, que contém superfície texturizada que ajuda a manter os dentes do seu cão limpos e saudáveis", 10,4),
        ...
        new Produto(21, "Comedouro", "Comedouro estilo cat.", "./imagens/acessorios/comedouro-gatos.jpg", 22.99, "acessorios", "Comedouro ou potinho para ração do seu gato na cor azul petróleo. O objeto é de plástico com formato de cabeça de gato com orelhinhas.", 10,4),
        ...
        new Produto(25, "Casa tunel", "Casinha confortavél para seu gatinho.", "./imagens/acessorios/toca-tunel-gato.jpg", 99.90, "acessorios", "Toca em formato triangular, almofadas por dentro e confortável. A toca é de cor branca com gatinhos coloridos desenhado, gatinhos azuis, lilás e amarelo.", 10,4),
        new Produto(26, "Cama pets", "Caminha ideal para seu pet, com o conforto que ele merece.", "./imagens/acessorios/caminha-pet.png", 59.90, "acessorios", "Camisa preta em formato quadrado, com patinhas brancas desenhadas e almofada por dentro. ideal para pet de porte médio.", 10,3)
    ]
